...
namespace ProjectX.SlideoutNavigation
{
    ...
    {
		readonly SlideoutNavigationController _slideoutNavigationController;
        ...
        public MenuNavigationController(UIViewController rootViewController, SlideoutNavigationController slideoutNavigationController, UIBarButtonItem right)
            : this(rootViewController, slideoutNavigationController)
        {
            NavigationItem.SetRightBarButtonItem(right, true);
        }
